...
## 43. Real-Time Clock (RTC) Module (e.g., DS3231)
Description: A battery-backed clock chip that keeps accurate track of the current time and date, even if the main Arduino loses power.
